...
//                     <tr
//                       key={patient.id}
//                       className="patients-row animate__animated animate__fadeInUp"
//                       onClick={fillMaternalProfile}
//                     >
//                       <td
//                         style={{
//                           color: "#336BFF",
...
const DoctorDashboard = () => {
  ...
  const fillMaternalProfile = (patient) => {
            ...
            <div className="m-profile-details">
              <div className="top">
                ...
                <div className="age-and-companion">
                  ...
                  <div className="companion">
                    <span className="b">Companion:</span>{" "}
                    {selectedPatient
              ...
              <div className="bottom">
                <div className="gestation-age">
                  <span className="b">Week:</span>{" "}
                  {selectedPatient ? selectedPatient.week : "wk"}
                </div>
                <div className="trimester">
                  <span className="b">Trimester:</span>{" "}
                  {selectedPatient ? selectedPatient.trimester : "tr"}
                </div>
                <div className="parity">
                  <span className="b">Parity:</span>{" "}
                  {selectedPatient ? `0+${selectedPatient.parity}` : "pr"}
                </div>
              </div>
            </div>
                ...
                <tbody>
                  {filteredPatients.map((patient) => (
                    <tr
                      ...
                      onClick={() => fillMaternalProfile(patient)}
                    >
                      <td
                        style={{
                          color: "#336BFF",
